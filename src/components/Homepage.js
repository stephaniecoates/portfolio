  ...
  render() {
    return (
      <Layout title={`SC`} location={this.props.location}>
       ...
       Currently, I work on cool digital projects with an amazing team at <a href="https://www.americanexpress.com" target="_blank" rel="noopener noreferrer" style={{color: '#006fcf'}}>American Express</a> and am available for <a href="/#contact" style={{color: '#8a9b7f'}}>remote freelance work</a>.</span>
